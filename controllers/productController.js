...
const newProduct = async (req, res) => {
    ...
    let myProduct = new Product(req.body)
    try {
        await myProduct.save();
        myProduct
        res.status(200).json({ myProduct: myProduct });
    }
    catch (error) {
...
module.exports = { newProduct, findUserById, getAllUsers, updateById, findUserByName, updateOne,deleteUserById,deleteOne }
